        ...
        <div id="app">
            <nav class="navber navber-expand-md navber-dark navber-laravel">
                <div class="container">
                    ...
                    <button class="navber-toggler" type="button" date-toggle="collapse" date-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expand="false" aria-label="Toggle navigation">
